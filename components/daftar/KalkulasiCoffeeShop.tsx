            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="w-full border-2 border-orange-400 rounded-xl p-4 text-lg bg-white/70 backdrop-blur focus:outline-none focus:ring-2 focus:ring-teal-300 transition h-12"
                    >
