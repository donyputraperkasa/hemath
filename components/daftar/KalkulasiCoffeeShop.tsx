...
export default function KalkulasiCoffeeShop() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-14 px-6">
            <h1 className="text-5xl font-extrabold text-center text-orange-600 mb-10 tracking-tight">
                Coffee Shop Kalkulasi
            </h1>
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="w-full border-2 border-orange-400 rounded-xl p-4 text-lg bg-white/70 backdrop-blur focus:outline-none focus:ring-2 focus:ring-teal-300 transition min-h-[52px]"
                    >
            ...
            <div className="text-center">
                ...
                <a
                    href={`https://wa.me/6282236343404?text=${encodeURIComponent(
                        `Halo, saya ingin daftar les di Coffee Shop.
