...
const FungsiKuadratProblem = [
    { Kesulitan: "mencari pembuat nol" },
    { Kesulitan: "perkalian (x-a)(x-b)" },
    { Kesulitan: "rumus ABC" },
    { Kesulitan: "mencari titik puncak" },
    { Kesulitan: "mencari x = 0" },
    { Kesulitan: "mencari y = 0" },
    { Kesulitan: "titik bantu" },
];
    ...
    return (
        <section className="py-16 text-center">
            ...
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-4 place-items-center">
                {FungsiKuadratProblem.map((item, index) => {
                return (
                    <div
                        key={index}
