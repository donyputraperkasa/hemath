...
const DanLainnyaProblem = [
    { Kesulitan: "materi TKA" },
    { Kesulitan: "materi UAS" },
    { Kesulitan: "persiapan ujian tengah semester" },
    { Kesulitan: "persiapan ujian akhir semester" },
    { Kesulitan: "trigonometri" },
    { Kesulitan: "integral fungsi" },
    { Kesulitan: "turunan fungsi" },
    { Kesulitan: "matriks" },
    { Kesulitan: "program linier" },
];

export default function DanLainnya() {
    return (
            ...
            <div className="mb-10 px-4">
                <div className="flex justify-center mb-3">
                    <div className="w-14 h-14 flex items-center justify-center rounded-full bg-indigo-100">
                        <Shapes className="text-indigo-500" size={28} />
                    </div>
                </div>
